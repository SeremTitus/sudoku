Public Class Form1
    ...
    Public Sub LoadGame()
        Dim Game As String
        Game = "_081700930409821006270000401760000028000057000000083079120064307907108205300000000"
        Dim Answer As String
        Answer = "_681745932439821756275396481763419528892657143514283679128564397947138265356972814"
    ...
    Private Sub HighlightRow()
        ...
        For i As Integer = StartRow To EndRow
            SudokuArray(i).BackColor = Color.Yellow
        Next
    End Sub
    ...
    Private Sub HighlightColumn()
        ...
        For i As Integer = StartCol To EndCol Step 9 ' Step by 9 to move down the column
            SudokuArray(i).BackColor = Color.Yellow
        Next
    End Sub
    ...
    Private Sub ResetBlockColor()
        ...
        For i As Integer = 1 To 81
            If SudokuArray(i) IsNot Nothing Then
                SudokuArray(i).BackColor = Color.White
            End If
        Next
    End Sub
    ...
    Function Notes(str As String, Value As Integer) As String
        ...
        If str.Substring(Position, 1) = Value.ToString Then
            ToggleNumber = " "
        End If
        'remove string
